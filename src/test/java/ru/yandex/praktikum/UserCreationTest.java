...
public class UserCreationTest {
    ...
    public void successfulCreationTest() {
        Response responseCreate = ru.yandex.praktikum.ClientBurger.sucUserReg(userCreation);
    ...
    public void regAnExistingUserTest() {
        ...
        Response responseCreateTwo = ru.yandex.praktikum.ClientBurger.sucUserReg(userCreation);
    ...
    public void regAnExistingUserNoEmailTest() {
        ...
        Response responseCreateTwo = ru.yandex.praktikum.ClientBurger.sucUserReg(userCreationNull);
        assertEquals(SC_FORBIDDEN, responseCreateTwo.statusCode());
    ...
    public void clear() {
        if (token != null) {
            ru.yandex.praktikum.ClientBurger.deleteUser(token);
        }
    }
}
